...
def is_criticality_balanced(temperature, neutrons_emitted):
    return temperature < 800 and neutrons_emitted > 500 and temperature*neutrons_emitted< 50000
...
def fail_safe(temperature, neutrons_produced_per_second, threshold): 
    ...
    lowe_limits = 0.9 * threshold
    upper_limit = 1.1 * threshold

    if criticality < lowe_limits:
        return "LOW"
    elif lowe_limits <= criticality <= upper_limit:
        return "NORMAL"
    else:
        return "DANGER"
